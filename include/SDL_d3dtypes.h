#ifndef SDL_D3DTYPES_H
#define SDL_D3DTYPES_H
 ...
 */
#define D3DRGB(r, g, b) \
    (0xff000000L | ( ((SDL_LONG)((r) * 255)) << 16) | (((SDL_LONG)((g) * 255)) << 8) | (SDL_LONG)((b) * 255))
#define D3DRGBA(r, g, b, a) \
    (	(((SDL_LONG)((a) * 255)) << 24) | (((SDL_LONG)((r) * 255)) << 16) \
    |	(((SDL_LONG)((g) * 255)) << 8) | (SDL_LONG)((b) * 255) \
    )
...
typedef SDL_HRESULT (SDL_WINAPI* LPD3DVALIDATECALLBACK)(SDL_LPVOID lpUserArg, SDL_DWORD dwOffset);
typedef SDL_HRESULT (SDL_WINAPI* LPD3DENUMTEXTUREFORMATSCALLBACK)(LPDDSURFACEDESC lpDdsd, SDL_LPVOID lpContext);

typedef SDL_DWORD D3DCOLOR, *LPD3DCOLOR;

typedef SDL_DWORD D3DMATERIALHANDLE, *LPD3DMATERIALHANDLE;
typedef SDL_DWORD D3DTEXTUREHANDLE, *LPD3DTEXTUREHANDLE;
typedef SDL_DWORD D3DMATRIXHANDLE, *LPD3DMATRIXHANDLE;
...
typedef struct _D3DHVERTEX {
    SDL_DWORD           dwFlags;        /* Homogeneous clipping flags */
    union {
        D3DVALUE    hx;
        D3DVALUE    dvHX;
    };
...
typedef struct _D3DVIEWPORT {
    SDL_DWORD       dwSize;
    SDL_DWORD       dwX;
    SDL_DWORD       dwY;		/* Top left */
    SDL_DWORD       dwWidth;
    SDL_DWORD       dwHeight;	/* Dimensions */
...
typedef struct _D3DVIEWPORT2 {
    SDL_DWORD       dwSize;
    SDL_DWORD       dwX;
    SDL_DWORD       dwY;		/* Viewport Top left */
    SDL_DWORD       dwWidth;
    SDL_DWORD       dwHeight;	/* Viewport Dimensions */
...
typedef struct _D3DTRANSFORMDATA {
    SDL_DWORD           dwSize;
    SDL_LPVOID	    lpIn;           /* Input vertices */
    SDL_DWORD           dwInSize;       /* Stride of input vertices */
    SDL_LPVOID	    lpOut;          /* Output vertices */
    SDL_DWORD           dwOutSize;      /* Stride of output vertices */
    LPD3DHVERTEX    lpHOut;         /* Output homogeneous vertices */
    SDL_DWORD           dwClip;         /* Clipping hint */
    SDL_DWORD           dwClipIntersection;
    SDL_DWORD           dwClipUnion;    /* Union of all clip flags */
...
typedef enum _D3DLIGHTTYPE {
    ...
    D3DLIGHT_FORCE_SDL_DSDL_WORD    = 0x7fffffff, /* force 32-bit size enum */
} D3DLIGHTTYPE;
...
typedef struct _D3DLIGHTDATA {
    ...
    SDL_DWORD                dwInSize;	/* Stride of input elements */
    LPD3DTLVERTEX        lpOut;		/* Output colors */
    SDL_DWORD                dwOutSize;	/* Stride of output colors */
...
typedef SDL_DWORD D3DCOLORMODEL;
...
typedef enum _D3DOPCODE {
    ...
    D3DOP_SPAN			= 13,
    D3DOP_SETSTATUS		= 14,
    D3DOP_FORCE_SDL_DSDL_WORD           = 0x7fffffff, /* force 32-bit size enum */
} D3DOPCODE;

typedef struct _D3DINSTRUCTION {
    SDL_BYTE bOpcode;   /* Instruction opcode */
    SDL_BYTE bSize;     /* Size of each instruction data unit */
    SDL_WORD wCount;    /* Count of instruction data units to follow */
...
typedef enum _D3DSHADEMODE {
    ...
    D3DSHADE_GOURAUD           = 2,
    D3DSHADE_PHONG             = 3,
    D3DSHADE_FORCE_SDL_DSDL_WORD       = 0x7fffffff, /* force 32-bit size enum */
} D3DSHADEMODE;
...
typedef enum _D3DFILLMODE {
    ...
    D3DFILL_WIREFRAME	       = 2,
    D3DFILL_SOLID	       = 3,
    D3DFILL_FORCE_SDL_DSDL_WORD        = 0x7fffffff, /* force 32-bit size enum */
} D3DFILLMODE;

typedef struct _D3DLINEPATTERN {
    SDL_WORD	wRepeatFactor;
    SDL_WORD	wLinePattern;
} D3DLINEPATTERN;
...
typedef enum _D3DTEXTUREFILTER {
    ...
    D3DFILTER_FORCE_SDL_DSDL_WORD      = 0x7fffffff, /* force 32-bit size enum */
} D3DTEXTUREFILTER;
...
typedef enum _D3DBLEND {
    ...
    D3DBLEND_FORCE_SDL_DSDL_WORD       = 0x7fffffff, /* force 32-bit size enum */
} D3DBLEND;
...
typedef enum _D3DTEXTUREBLEND {
    ...
    D3DTBLEND_COPY             = 7,
    D3DTBLEND_ADD              = 8,
    D3DTBLEND_FORCE_SDL_DSDL_WORD      = 0x7fffffff, /* force 32-bit size enum */
} D3DTEXTUREBLEND;
...
typedef enum _D3DTEXTUREADDRESS {
    ...
    D3DTADDRESS_FORCE_SDL_DSDL_WORD    = 0x7fffffff, /* force 32-bit size enum */
} D3DTEXTUREADDRESS;
...
typedef enum _D3DCULL {
    ...
    D3DCULL_CW                 = 2,
    D3DCULL_CCW                = 3,
    D3DCULL_FORCE_SDL_DSDL_WORD        = 0x7fffffff, /* force 32-bit size enum */
} D3DCULL;
...
typedef enum _D3DCMPFUNC {
    ...
    D3DCMP_ALWAYS              = 8,
    D3DCMP_FORCE_SDL_DSDL_WORD         = 0x7fffffff, /* force 32-bit size enum */
} D3DCMPFUNC;
...
typedef enum _D3DFOGMODE {
    ...
    D3DFOG_EXP2                = 2,
    D3DFOG_LINEAR              = 3,
    D3DFOG_FORCE_SDL_DSDL_WORD         = 0x7fffffff, /* force 32-bit size enum */
} D3DFOGMODE;
...
typedef enum _D3DANTIALIASMODE {
    ...
    D3DANTIALIAS_FORCE_SDL_DSDL_WORD   = 0x7fffffff, /* force 32-bit size enum */
} D3DANTIALIASMODE;
...
typedef enum _D3DVERTEXTYPE {
    ...
    D3DVT_LVERTEX       = 2,
    D3DVT_TLVERTEX      = 3,
    D3DVT_FORCE_SDL_DSDL_WORD   = 0x7fffffff, /* force 32-bit size enum */
} D3DVERTEXTYPE;
...
typedef enum _D3DPRIMITIVETYPE {
    ...
    D3DPT_TRIANGLEFAN   = 6,
    D3DPT_FORCE_SDL_DSDL_WORD   = 0x7fffffff, /* force 32-bit size enum */
} D3DPRIMITIVETYPE;
 ...
 */
#define D3DSTATE_OVERRIDE(type) ((SDL_DWORD) (type) + D3DSTATE_OVERRIDE_BIAS)

typedef enum _D3DTRANSFORMSTATETYPE {
    D3DTRANSFORMSTATE_WORLD           = 1,
    D3DTRANSFORMSTATE_VIEW            = 2,
    D3DTRANSFORMSTATE_PROJECTION      = 3,
    D3DTRANSFORMSTATE_FORCE_SDL_DSDL_WORD     = 0x7fffffff, /* force 32-bit size enum */
...
typedef enum _D3DLIGHTSTATETYPE {
    ...
    D3DLIGHTSTATE_FORCE_SDL_DSDL_WORD         = 0x7fffffff, /* force 32-bit size enum */
} D3DLIGHTSTATETYPE;
...
typedef enum _D3DRENDERSTATETYPE {
    ...
    D3DRENDERSTATE_PLANEMASK          = 13,   /* SDL_DWORD physical plane mask */
    ...
    D3DRENDERSTATE_ZBIAS              = 47,   /* SDL_LONG Z bias */
    ...
    D3DRENDERSTATE_FORCE_SDL_DSDL_WORD        = 0x7fffffff, /* force 32-bit size enum */
} D3DRENDERSTATETYPE;
...
typedef struct _D3DPROCESSVERTICES {
    SDL_DWORD        dwFlags;    /* Do we transform or light or just copy? */
    SDL_WORD         wStart;     /* Index to first vertex in source	*/
    SDL_WORD         wDest;      /* Index to first vertex in local buffer */
    SDL_DWORD        dwCount;    /* Number of vertices to be processed */
    SDL_DWORD	 dwReserved; /* Must be zero */
...
typedef struct _D3DTRIANGLE {
    ...
    SDL_WORD    	wFlags;       /* Edge (and other) flags */
...
typedef struct _D3DSPAN {
    SDL_WORD	wCount;	/* Number of spans */
    SDL_WORD	wFirst;	/* Index to first vertex */
} D3DSPAN, *LPD3DSPAN;
...
typedef struct _D3DPOINT {
    SDL_WORD	wCount;		/* number of points	    */
    SDL_WORD	wFirst;		/* index to first vertex    */
} D3DPOINT, *LPD3DPOINT;
...
typedef struct _D3DBRANCH {
    SDL_DWORD	dwMask;		/* Bitmask against D3D status */
    SDL_DWORD	dwValue;
    SDL_BOOL	bNegate;    	/* TRUE to negate comparison */
    SDL_DWORD	dwOffset;	/* How far to branch forward (0 for exit)*/
...
typedef struct _D3DSTATUS {
    SDL_DWORD       dwFlags;	/* Do we set extents or status */
    SDL_DWORD	dwStatus;	/* D3D status */
    D3DRECT	drExtent;
...
typedef struct _D3DCLIPSTATUS {
    SDL_DWORD dwFlags; /* Do we set 2d extents, 3D extents or status */
    SDL_DWORD dwStatus; /* Clip status */
...
typedef struct _D3DSTATS {
    SDL_DWORD        dwSize;
    SDL_DWORD        dwTrianglesDrawn;
    SDL_DWORD        dwLinesDrawn;
    SDL_DWORD        dwPointsDrawn;
    SDL_DWORD        dwSpansDrawn;
    SDL_DWORD        dwVerticesProcessed;
} D3DSTATS, *LPD3DSTATS;
...
typedef struct _D3DEXECUTEDATA {
    SDL_DWORD       dwSize;
    SDL_DWORD       dwVertexOffset;
    SDL_DWORD       dwVertexCount;
    SDL_DWORD       dwInstructionOffset;
    SDL_DWORD       dwInstructionLength;
    SDL_DWORD       dwHVertexOffset;
