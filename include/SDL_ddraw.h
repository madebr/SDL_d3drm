...
SDL_DEFINE_GUID( CLSID_DirectDraw,                0xD7B70EE0,0x4340,0x11CF,0xB0,0x63,0x00,0x20,0xAF,0xC2,0xCD,0x35 );
SDL_DEFINE_GUID( CLSID_DirectDrawClipper,         0x593817A0,0x7DB3,0x11CF,0xA2,0xDE,0x00,0xAA,0x00,0xb9,0x33,0x56 );
SDL_DEFINE_GUID( IID_IDirectDraw,                 0x6C14DB80,0xA733,0x11CE,0xA5,0x21,0x00,0x20,0xAF,0x0B,0xE5,0x60 );
SDL_DEFINE_GUID( IID_IDirectDraw2,                0xB3A6F3E0,0x2B43,0x11CF,0xA2,0xDE,0x00,0xAA,0x00,0xB9,0x33,0x56 );
SDL_DEFINE_GUID( IID_IDirectDrawSurface,          0x6C14DB81,0xA733,0x11CE,0xA5,0x21,0x00,0x20,0xAF,0x0B,0xE5,0x60 );
SDL_DEFINE_GUID( IID_IDirectDrawSurface2,         0x57805885,0x6eec,0x11cf,0x94,0x41,0xa8,0x23,0x03,0xc1,0x0e,0x27 );
SDL_DEFINE_GUID( IID_IDirectDrawSurface3,         0xDA044E00,0x69B2,0x11D0,0xA1,0xD5,0x00,0xAA,0x00,0xB8,0xDF,0xBB )    ;

SDL_DEFINE_GUID( IID_IDirectDrawPalette,          0x6C14DB84,0xA733,0x11CE,0xA5,0x21,0x00,0x20,0xAF,0x0B,0xE5,0x60 );
SDL_DEFINE_GUID( IID_IDirectDrawClipper,          0x6C14DB85,0xA733,0x11CE,0xA5,0x21,0x00,0x20,0xAF,0x0B,0xE5,0x60 );
SDL_DEFINE_GUID( IID_IDirectDrawColorControl,     0x4B9F0EE0,0x0D7E,0x11D0,0x9B,0x06,0x00,0xA0,0xC9,0x03,0xA3,0xB8 );
...
#endif
extern SDL_HRESULT SDL_WINAPI DirectDrawCreate( SDL_GUID SDL_FAR *lpGUID, LPDIRECTDRAW SDL_FAR *lplpDD, IUnknown SDL_FAR *pUnkOuter );
extern SDL_HRESULT SDL_WINAPI DirectDrawCreateClipper( SDL_DWORD dwFlags, LPDIRECTDRAWCLIPPER SDL_FAR *lplpDDClipper, IUnknown SDL_FAR *pUnkOuter );
#endif
...
SDL_DECLARE_INTERFACE_( IDirectDraw, IUnknown )
{
/*** IUnknown methods ***/
...
SDL_STDMETHOD(Compact)(SDL_THIS) SDL_PURE;
        SDL_STDMETHOD(CreateClipper)(SDL_THIS_ SDL_DWORD, LPDIRECTDRAWCLIPPER SDL_FAR*, IUnknown SDL_FAR * ) SDL_PURE;
SDL_STDMETHOD(CreatePalette)(SDL_THIS_ SDL_DWORD, LPPALETTEENTRY, LPDIRECTDRAWPALETTE SDL_FAR*, IUnknown SDL_FAR * ) SDL_PURE;
SDL_STDMETHOD(CreateSurface)(SDL_THIS_  LPDDSURFACEDESC, LPDIRECTDRAWSURFACE SDL_FAR *, IUnknown SDL_FAR *) SDL_PURE;
...
SDL_DECLARE_INTERFACE_( IDirectDraw2, IUnknown )
{
/*** IUnknown methods ***/
SDL_STDMETHOD(QueryInterface) (SDL_THIS_ SDL_REFIID riid, SDL_LPVOID SDL_FAR * ppvObj) SDL_PURE;
SDL_STDMETHOD_(SDL_ULONG,AddRef) (SDL_THIS)  SDL_PURE;
...
SDL_DECLARE_INTERFACE_( IDirectDrawPalette, IUnknown )
{
/*** IUnknown methods ***/
SDL_STDMETHOD(QueryInterface) (SDL_THIS_ SDL_REFIID riid, SDL_LPVOID SDL_FAR * ppvObj) SDL_PURE;
SDL_STDMETHOD_(SDL_ULONG,AddRef) (SDL_THIS)  SDL_PURE;
...
SDL_STDMETHOD(GetCaps)(SDL_THIS_ SDL_LPDWORD) SDL_PURE;
        SDL_STDMETHOD(GetEntries)(SDL_THIS_ SDL_DWORD,SDL_DWORD,SDL_DWORD,LPPALETTEENTRY) SDL_PURE;
SDL_STDMETHOD(Initialize)(SDL_THIS_ LPDIRECTDRAW, SDL_DWORD, LPPALETTEENTRY) SDL_PURE;
        SDL_STDMETHOD(SetEntries)(SDL_THIS_ SDL_DWORD,SDL_DWORD,SDL_DWORD,LPPALETTEENTRY) SDL_PURE;
};
#undef SDL_INTERFACE
...
SDL_DECLARE_INTERFACE_( IDirectDrawClipper, IUnknown )
{
/*** IUnknown methods ***/
SDL_STDMETHOD(QueryInterface) (SDL_THIS_ SDL_REFIID riid, SDL_LPVOID SDL_FAR * ppvObj) SDL_PURE;
SDL_STDMETHOD_(SDL_ULONG,AddRef) (SDL_THIS)  SDL_PURE;
...
SDL_STDMETHOD(GetClipList)(SDL_THIS_ LPRECT, LPRGNDATA, SDL_LPDWORD) SDL_PURE;
...
SDL_STDMETHOD(SetClipList)(SDL_THIS_ LPRGNDATA,SDL_DWORD) SDL_PURE;
...
SDL_DECLARE_INTERFACE_( IDirectDrawSurface, IUnknown )
{
/*** IUnknown methods ***/
SDL_STDMETHOD(QueryInterface) (SDL_THIS_ SDL_REFIID riid, SDL_LPVOID SDL_FAR * ppvObj) SDL_PURE;
SDL_STDMETHOD_(SDL_ULONG,AddRef) (SDL_THIS)  SDL_PURE;
...
SDL_STDMETHOD(AddAttachedSurface)(SDL_THIS_ LPDIRECTDRAWSURFACE) SDL_PURE;
        SDL_STDMETHOD(AddOverlayDirtyRect)(SDL_THIS_ LPRECT) SDL_PURE;
SDL_STDMETHOD(Blt)(SDL_THIS_ LPRECT,LPDIRECTDRAWSURFACE, LPRECT,SDL_DWORD, LPDDBLTFX) SDL_PURE;
        SDL_STDMETHOD(BltBatch)(SDL_THIS_ LPDDBLTBATCH, SDL_DWORD, SDL_DWORD ) SDL_PURE;
SDL_STDMETHOD(BltFast)(SDL_THIS_ SDL_DWORD,SDL_DWORD,LPDIRECTDRAWSURFACE, LPRECT,SDL_DWORD) SDL_PURE;
...
SDL_STDMETHOD(Lock)(SDL_THIS_ LPRECT,LPDDSURFACEDESC,SDL_DWORD,SDL_HANDLE) SDL_PURE;
...
SDL_STDMETHOD(UpdateOverlay)(SDL_THIS_ LPRECT, LPDIRECTDRAWSURFACE,LPRECT,SDL_DWORD, LPDDOVERLAYFX) SDL_PURE;
...
SDL_DECLARE_INTERFACE_( IDirectDrawSurface2, IUnknown )
{
/*** IUnknown methods ***/
SDL_STDMETHOD(QueryInterface) (SDL_THIS_ SDL_REFIID riid, SDL_LPVOID SDL_FAR * ppvObj) SDL_PURE;
SDL_STDMETHOD_(SDL_ULONG,AddRef) (SDL_THIS)  SDL_PURE;
...
SDL_STDMETHOD(AddAttachedSurface)(SDL_THIS_ LPDIRECTDRAWSURFACE2) SDL_PURE;
        SDL_STDMETHOD(AddOverlayDirtyRect)(SDL_THIS_ LPRECT) SDL_PURE;
SDL_STDMETHOD(Blt)(SDL_THIS_ LPRECT,LPDIRECTDRAWSURFACE2, LPRECT,SDL_DWORD, LPDDBLTFX) SDL_PURE;
        SDL_STDMETHOD(BltBatch)(SDL_THIS_ LPDDBLTBATCH, SDL_DWORD, SDL_DWORD ) SDL_PURE;
SDL_STDMETHOD(BltFast)(SDL_THIS_ SDL_DWORD,SDL_DWORD,LPDIRECTDRAWSURFACE2, LPRECT,SDL_DWORD) SDL_PURE;
...
SDL_STDMETHOD(SetPalette)(SDL_THIS_ LPDIRECTDRAWPALETTE) SDL_PURE;
        SDL_STDMETHOD(Unlock)(SDL_THIS_ SDL_LPVOID) SDL_PURE;
SDL_STDMETHOD(UpdateOverlay)(SDL_THIS_ LPRECT, LPDIRECTDRAWSURFACE2,LPRECT,SDL_DWORD, LPDDOVERLAYFX) SDL_PURE;
        SDL_STDMETHOD(UpdateOverlayDisplay)(SDL_THIS_ SDL_DWORD) SDL_PURE;
...
SDL_DECLARE_INTERFACE_( IDirectDrawSurface3, IUnknown )
{
/*** IUnknown methods ***/
SDL_STDMETHOD(QueryInterface) (SDL_THIS_ SDL_REFIID riid, SDL_LPVOID SDL_FAR * ppvObj) SDL_PURE;
SDL_STDMETHOD_(SDL_ULONG,AddRef) (SDL_THIS)  SDL_PURE;
...
SDL_STDMETHOD(AddAttachedSurface)(SDL_THIS_ LPDIRECTDRAWSURFACE3) SDL_PURE;
        SDL_STDMETHOD(AddOverlayDirtyRect)(SDL_THIS_ LPRECT) SDL_PURE;
SDL_STDMETHOD(Blt)(SDL_THIS_ LPRECT,LPDIRECTDRAWSURFACE3, LPRECT,SDL_DWORD, LPDDBLTFX) SDL_PURE;
        SDL_STDMETHOD(BltBatch)(SDL_THIS_ LPDDBLTBATCH, SDL_DWORD, SDL_DWORD ) SDL_PURE;
SDL_STDMETHOD(BltFast)(SDL_THIS_ SDL_DWORD,SDL_DWORD,LPDIRECTDRAWSURFACE3, LPRECT,SDL_DWORD) SDL_PURE;
...
SDL_STDMETHOD(SetPalette)(SDL_THIS_ LPDIRECTDRAWPALETTE) SDL_PURE;
        SDL_STDMETHOD(Unlock)(SDL_THIS_ SDL_LPVOID) SDL_PURE;
SDL_STDMETHOD(UpdateOverlay)(SDL_THIS_ LPRECT, LPDIRECTDRAWSURFACE3,LPRECT,SDL_DWORD, LPDDOVERLAYFX) SDL_PURE;
        SDL_STDMETHOD(UpdateOverlayDisplay)(SDL_THIS_ SDL_DWORD) SDL_PURE;
...
SDL_DECLARE_INTERFACE_( IDirectDrawColorControl, IUnknown )
{
/*** IUnknown methods ***/
SDL_STDMETHOD(QueryInterface) (SDL_THIS_ SDL_REFIID riid, SDL_LPVOID SDL_FAR * ppvObj) SDL_PURE;
SDL_STDMETHOD_(SDL_ULONG,AddRef) (SDL_THIS)  SDL_PURE;
