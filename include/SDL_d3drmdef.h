#ifndef SDL_D3DRMDEFS_H
#define SDL_D3DRMDEFS_H
...
typedef SDL_DWORD D3DRMRENDERQUALITY, *LPD3DRMRENDERQUALITY;
...
typedef struct _D3DRMIMAGE {
    ...
    void* buffer2;
    SDL_ULONG red_mask;
    SDL_ULONG green_mask;
    SDL_ULONG blue_mask;
    SDL_ULONG alpha_mask;
    int palette_size;
...
typedef SDL_DWORD D3DRMSAVEOPTIONS;
...
typedef SDL_DWORD D3DRMANIMATIONOPTIONS;
...
typedef SDL_DWORD D3DRMINTERPOLATIONOPTIONS;
...
typedef SDL_DWORD D3DRMLOADOPTIONS;
...
typedef struct _D3DRMPMESHLOADSTATUS {
    SDL_DWORD dwSize;
    SDL_DWORD dwPMeshSize;
    SDL_DWORD dwBaseMeshSize;
    SDL_DWORD dwBytesLoaded;
    SDL_DWORD dwVerticesLoaded;
    SDL_DWORD dwFacesLoaded;
    SDL_HRESULT dwLoadResult;
    SDL_DWORD dwFlags;
...
typedef SDL_DWORD D3DRMMAPPING, D3DRMMAPPINGFLAG, *LPD3DRMMAPPING;
...
typedef SDL_LONG D3DRMGROUPINDEX;
...
D3DRMQUATERNION * SDL_WINAPI D3DRMQuaternionSlerp(D3DRMQUATERNION *ret,
...
D3DVECTOR * SDL_WINAPI D3DRMVectorRotate(D3DVECTOR *ret, const D3DVECTOR *x, const D3DVECTOR *axis, D3DVALUE theta);
D3DVECTOR * SDL_WINAPI D3DRMVectorReflect(D3DVECTOR *ret, const D3DVECTOR *ray, const D3DVECTOR *normal);
D3DVECTOR * SDL_WINAPI D3DRMVectorScale(D3DVECTOR *ret, const D3DVECTOR *x, D3DVALUE scale);
D3DVECTOR * SDL_WINAPI D3DRMVectorSubtract(D3DVECTOR *ret, const D3DVECTOR *x, const D3DVECTOR *y);

D3DCOLOR SDL_WINAPI D3DRMCreateColorRGB(D3DVALUE, D3DVALUE, D3DVALUE);
D3DCOLOR SDL_WINAPI D3DRMCreateColorRGBA(D3DVALUE, D3DVALUE, D3DVALUE, D3DVALUE);
D3DVALUE SDL_WINAPI D3DRMColorGetAlpha(D3DCOLOR);
D3DVALUE SDL_WINAPI D3DRMColorGetBlue(D3DCOLOR);
D3DVALUE SDL_WINAPI D3DRMColorGetGreen(D3DCOLOR);
D3DVALUE SDL_WINAPI D3DRMColorGetRed(D3DCOLOR);

#if defined(__cplusplus)
}
#endif

#endif // SDL_D3DRMDEF_H
