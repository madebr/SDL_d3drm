...
SDL_DECLARE_INTERFACE_(IDirect3D, IUnknown)
{
    /*** IUnknown methods ***/
    ...
    SDL_STDMETHOD(CreateLight) (SDL_THIS_ LPDIRECT3DLIGHT*, IUnknown*) SDL_PURE;
    SDL_STDMETHOD(CreateMaterial) (SDL_THIS_ LPDIRECT3DMATERIAL*, IUnknown*) SDL_PURE;
    SDL_STDMETHOD(CreateViewport) (SDL_THIS_ LPDIRECT3DVIEWPORT*, IUnknown*) SDL_PURE;
...
SDL_DECLARE_INTERFACE_(IDirect3D2, IUnknown)
{
    /*** IUnknown methods ***/
    SDL_IUNKNOWN_METHODS(SDL_PURE);
    /*** IDirect3D methods ***/
    SDL_STDMETHOD(EnumDevices)(SDL_THIS_ LPD3DENUMDEVICESCALLBACK, SDL_LPVOID) SDL_PURE;
    SDL_STDMETHOD(CreateLight) (SDL_THIS_ LPDIRECT3DLIGHT*, IUnknown*) SDL_PURE;
    SDL_STDMETHOD(CreateMaterial) (SDL_THIS_ LPDIRECT3DMATERIAL2*, IUnknown*) SDL_PURE;
    SDL_STDMETHOD(CreateViewport) (SDL_THIS_ LPDIRECT3DVIEWPORT2*, IUnknown*) SDL_PURE;
    SDL_STDMETHOD(FindDevice)(SDL_THIS_ LPD3DFINDDEVICESEARCH, LPD3DFINDDEVICERESULT) SDL_PURE;
...
SDL_DECLARE_INTERFACE_(IDirect3DDevice, IUnknown)
{
    /*** IUnknown methods ***/
    SDL_IUNKNOWN_METHODS(SDL_PURE);
    ...
    SDL_STDMETHOD(CreateExecuteBuffer) (SDL_THIS_ LPD3DEXECUTEBUFFERDESC, LPDIRECT3DEXECUTEBUFFER*, IUnknown*) SDL_PURE;
...
SDL_DECLARE_INTERFACE_(IDirect3DDevice2, IUnknown)
{
    /*** IUnknown methods ***/
    SDL_IUNKNOWN_METHODS(SDL_PURE);
...
SDL_DECLARE_INTERFACE_(IDirect3DExecuteBuffer, IUnknown)
{
    /*** IUnknown methods ***/
    SDL_IUNKNOWN_METHODS(SDL_PURE);
...
SDL_DECLARE_INTERFACE_(IDirect3DLight, IUnknown)
{
    /*** IUnknown methods ***/
    SDL_IUNKNOWN_METHODS(SDL_PURE);
...
SDL_DECLARE_INTERFACE_(IDirect3DMaterial, IUnknown)
{
    /*** IUnknown methods ***/
    SDL_IUNKNOWN_METHODS(SDL_PURE);
...
SDL_DECLARE_INTERFACE_(IDirect3DMaterial2, IUnknown)
{
    /*** IUnknown methods ***/
    SDL_IUNKNOWN_METHODS(SDL_PURE);
...
SDL_DECLARE_INTERFACE_(IDirect3DTexture, IUnknown)
{
    /*** IUnknown methods ***/
    SDL_IUNKNOWN_METHODS(SDL_PURE);
...
SDL_DECLARE_INTERFACE_(IDirect3DTexture2, IUnknown)
{
    /*** IUnknown methods ***/
    SDL_IUNKNOWN_METHODS(SDL_PURE);
...
SDL_DECLARE_INTERFACE_(IDirect3DViewport, IUnknown)
{
    /*** IUnknown methods ***/
    SDL_IUNKNOWN_METHODS(SDL_PURE);
